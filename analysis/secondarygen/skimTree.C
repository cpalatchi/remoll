void makelist(TString maindir="/volatile/halla/moller12gev/palatchi/", TString subdir="remoll_ferrous_parallel_100M_20211211", int NkEv = 100, int Nfiles=1000, TString outfilename = "mylist.txt"){
