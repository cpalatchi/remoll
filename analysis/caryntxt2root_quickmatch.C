void caryntxt2root_quickmatch(){
  ...
  //  TString infilename1=Form("/volatile/halla/moller12gev/palatchi/remoll_bellows_beam_ftsdV2Uvirtual/remoll_electrons_ftsdV2Uvirtual_quickmatch_det%d.txt",0);
  TString infilename1=Form("/volatile/halla/moller12gev/palatchi/remoll_bellows_beam_ftsdV2Uvirtual/remoll_electrons_ftsdV2Uvirtual_quickmatch_detmanualcopy.txt");
 ...
 TString outfilename = Form("/volatile/halla/moller12gev/palatchi/remoll_bellows_beam_ftsdV2Uvirtual/count_ftsdV2Uvirtual_quickmatch.root");
